...
public class PaymentController implements Initializable {
    ...
    @FXML
    private TextField txtcrditamt;
    @FXML
    private TextField txtadv;
    @FXML
    private TextField txtcrditbal;
    @FXML
    private RadioButton rbtCcash;
    @FXML
    private RadioButton rbtCbank;
    @FXML
    ...
    private void listner_radio_selection() {
        ...
        rbtCbank.setToggleGroup(grp2);
        rbtCcash.setToggleGroup(grp2);
